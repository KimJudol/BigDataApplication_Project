...
VALUES
     (1, 1, 'Han Cook Mat Jib', '한식', '123 Rue de la Liberté, Paris, 75001, France',1),
     ...
     (5, 5, 'Gam Dong Han Sik', '한식', '123 Via del Corso, Rome, 00186, Italy',10),
     (6, 1, 'Hanaki', '일식', '456 Avenue des Champs-Élysées, Nice, 06000, France',2),
     (7, 2, 'Sora', '일식', '456 Avenue, Karlovy Vary, 360 01, Czech Republic',5),
     (8, 3, 'Mizu', '일식', '456 Lake Geneva Road, Geneva, 1201, Switzerland',7),
     (9, 4, 'Sakura', '일식', '456 Abbey Road, Liverpool, L1 9EE, United Kingdom',9),
     (10, 5, 'Ichigo', '일식', '789 Via Condotti, Rome, 00187, Italy',11),
     (11, 1, 'Geumryong', '중식', '789 Boulevard Saint-Germain, Lyon, 69001, France',3),
     (12, 2, 'Dalma', '중식', '789 Brno Boulevard, Brno, 602 00, Czech Republic',4),
     (13, 3, 'Manli', '중식', '789 Matterhorn Avenue, Zermatt, 3920, Switzerland',6),
     (14, 4, 'Cheongryong', '중식', '789 Baker Street, London, NW1 6XE, United Kingdom',8),
     (15, 5, 'Hyangto', '중식', '101 Via Montenapoleone, Milan, 20121, Italy',12),
     (16, 1, 'La Cucina', '양식', 'Rue du Saint-Honoré, Marseille, 13001, France',1),
     (17, 2, 'Bourgogne', '양식', '101 Ostrava Lane, Ostrava, 702 00, Czech Republic',5),
     (18, 3, 'The Table', '양식', '101 Rhine River Drive, Basel, 4001, Switzerland',7),
     (19, 4, 'Garden', '양식', '101 Regent, Manchester, M1 5TA, United Kingdom',9),
     (20, 5, 'Bistro Bleu', '양식', '567 Via dei Fori Imperiali, Rome, 00186, Italy',10),
     ...
     (23, 3, 'Lantern Lane', '중식', '234 Jungfrau Lane, Interlaken, 3800, Switzerland',6),
     (24, 2, 'Tokyo Taste', '일식', '333 Pardubice, Pardubice, 530 02, Czech Republic',4),
     (25, 1, 'Han Cook', '한식', '234 Quai des Chartrons, Bordeaux, 33000, France',2),
     (26, 5, 'Han Kitchen', '한식', '222 Piazzale Michelangelo, Florence, 50125, Italy',12),
     (27, 4, 'Sushi House', '일식', '567 KingRoad, London, SW10 0BB, United Kingdom',9),
     (28, 3, 'Chopsticks Fortune', '중식', '567 Lucerne Boulevard, Lucerne, 6000, Switzerland',7),
     (29, 2, 'Maison Mimi', '양식', '222 Olomouc Road, Olomouc, 771 00, Czech Republic',5),
     (30, 1, 'Gourmet Galaxy', '양식', '567 Place de la République, Lille, 59000, France',3),
     (31, 2, 'Culinary Canvas', '양식', '555 Masaryk Square, Brno, 600 01, Czech Republic',4),
     (32, 5, 'Dragon Palace', '중식', '333 Via Appia Antica, Rome, 00179, Italy',10),
     (33, 4, 'Palace', '중식', '890 Princes, Edinburgh, EH2 2ER, United Kingdom',8),
     (34, 3, 'The Table', '일식', '890 Bernese Oberland, Bern, 3011, Switzerland',6),
     (35, 2, 'Umi', '일식', '1111 Boulevard, Vary, 361 00, Czech Republic',5),
     (36, 3, 'Gam Dong', '한식', '111 Swiss National Park, Zernez, 7530, Switzerland',7),
     (37, 4, 'K-Food', '한식', '111 Portland, London, W1W 6QQ, United Kingdom',9),
     (38, 1, 'Sushi Bar', '일식', '890 Rue du Mont-Cenis, Grenoble, 38000, France',1),
     (39, 5, 'Sushi Lounge', '일식', '444 Via Garibaldi, Naples, 80142, Italy',11),
     (40, 1, 'EdelBite', '양식', '111 Rue du Temple, Strasbourg, 67000, France',2);
